...
class prediction(object):
    ...
    def extract_feature(self, filename):
        ...
        playing_stat = playing_stat.drop(
            ['lunci', 'HTGS', 'ATGS', 'HTGC', 'ATGC', 'HomeLP', 'AwayLP', 'HTFormPts', 'ATFormPts', 'VTFormPtsStr',
        ...
        playing_stat = playing_stat.drop(['HTWinStreak3', 'HTWinStreak5', 'HTLossStreak3', 'HTLossStreak5', 'ATWinStreak3', 'ATWinStreak5',
                   'ATLossStreak3', 'ATLossStreak5', 'VTWinStreak3', 'VTWinStreak5', 'VTLossStreak3', 'VTLossStreak5',
...
if __name__ == '__main__':  # 在win系统下必须要满足这个if条件
    ...
    # load xgboost model
    xgboost_model = joblib.load('./prediction/model/xgboost_joblib(英冠).dat')
